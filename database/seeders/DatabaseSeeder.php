...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $skillsData = [
            ...
            [
                'name' => 'Java Swing / Desktop Apps',
                'category' => 'Frontend Development',
                'level' => 72,
                'icon' => 'fa-solid fa-window-restore',
                'description' => 'Membangun aplikasi desktop interaktif dengan GUI untuk sistem kasir dan review management.',
            ],
            [
        ...
        $projectsData = [
            ...
            [
                'title' => 'Monitoring IoT Laravel',
                'description' => 'Versi awal dashboard monitoring IoT berbasis Laravel untuk visualisasi data perangkat dan sensor.',
                'tech_stack' => ['Laravel', 'IoT', 'MySQL'],
                'role' => 'Fullstack Developer',
                'image_path' => 'images/projects/logistics.png',
                'project_url' => null,
                'github_url' => 'https://github.com/MuhammadAmirN/laravel_MonitoringIoT',
                'featured' => false,
                'contribution_percentage' => 100,
            ],
            [
            ...
            [
                'title' => 'Bookings Ticket',
                'description' => 'Aplikasi pemesanan tiket berbasis Python untuk booking dan validasi data reservasi.',
                'tech_stack' => ['Python', 'Streamlit', 'Booking System'],
                'role' => 'Python Developer',
                'image_path' => 'images/projects/tiket_bola.png',
                'project_url' => null,
                'github_url' => 'https://github.com/MuhammadAmirN/bookings-ticket',
                'featured' => false,
                'contribution_percentage' => 100,
            ],
            [
